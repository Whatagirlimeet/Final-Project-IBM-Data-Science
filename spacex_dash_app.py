...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title='Success Rate of CCAFS LC-40 Launch Sites')
        return fig
        ...
        names='class', 
        title='Success Rate of VAFB SLC-4E Launch Sites')
        return fig
        # return the outcomes piechart for a selected site
        ...
        names='class', 
        title='Success Rate of KSC LC-39A Launch Sites')
        return fig
        # return the outcomes piechart for a selected site
        ...
        names='class', 
        title='Success Rate of CCAFS SLC-40 Launch Sites')
        return fig
        # return the outcomes piechart for a selected site
...
def get_scatter_chart(entered_site,payload):
    filtered_df = spacex_df.copy()
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df[filtered_df["Payload Mass (kg)"].between(float(payload[0]),
        float(payload[1]))],x='Payload Mass (kg)', y='class',color='Booster Version Category',
